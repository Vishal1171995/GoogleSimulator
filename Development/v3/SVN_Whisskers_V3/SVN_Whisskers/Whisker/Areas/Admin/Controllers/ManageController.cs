    ...
    public class ManageController : Controller
    {
        ...
        public ActionResult CreateStudent(FormCollection fc)
        {
            ...
            if (fc["hdnStudentCode"].ToUpper() == "0")
            {
                ...
                objDBentity.prcCreateStudent(stdtDtl.FirstName, stdtDtl.MiddleName, stdtDtl.LastName, stdtDtl.Location, stdtDtl.Email, randomPwd, stdtDtl.Contact, stdtDtl.LocationCode, null, "INSERT",false);
                cmnF.SendPasscodeToMail(stdtDtl.Email, stdtDtl.FirstName, randomPwd, stdtDtl.Email, "whisskers login details");
                ContentResult.Add("0");//to show response of create message
                ContentResult.Add("1");//to show response of stored procedure working correctly
            }
            if (fc["hdnStudentCode"].ToUpper() != "0")
            {
                objDBentity.prcCreateStudent(stdtDtl.FirstName, stdtDtl.MiddleName, stdtDtl.LastName, stdtDtl.Location, stdtDtl.Email, null, stdtDtl.Contact, stdtDtl.LocationCode, fc["hdnStudentCode"], "UPDATE",false);
                ContentResult.Add("1");//to show response of edit message
                ContentResult.Add("1");//to show response of stored procedure working correctly
            }
        Exitlabel:
        ...
        public JsonResult deleteSingleStudent(string StudentCode)
        {
            ...
            if (TempResult2.Count <= 0)
            {
                objDBentity.prcCreateStudent(null, null, null, null, null, null, null, null, StudentCode, "DELETE",false);
                ContentResult.Add("1");
                ContentResult.Add("1");
            }
        Exitlabel:
